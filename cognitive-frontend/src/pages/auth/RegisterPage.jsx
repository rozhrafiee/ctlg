    ...
    <>
      ...
      <Card className="w-full max-w-lg">
        ...
        <form className="grid grid-cols-1 md:grid-cols-2 gap-3" onSubmit={onSubmit}>
          <Input id="password" name="password" id="last_name" name="last_name" id="first_name" name="first_name" id="email" name="email" id="username" name="username" placeholder="نام کاربری" value={form.username} onChange={(e) => setForm({ ...form, username: e.target.value })} />
          ...
          <Select id="role" name="role" value={form.role} onChange={(e) => setForm({ ...form, role: e.target.value })}>
