...
class StudentTestListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return CognitiveTest.objects.filter(
            is_active=True, min_level__lte=level
        ).exclude(test_type='placement')
    ...
    def list(self, request, *args, **kwargs):
        ...
        sort_algo = request.query_params.get('sort_algo') or user.preferred_sort_algorithm
        search_algo = request.query_params.get('search_algo') or user.preferred_search_algorithm
        sort_by = request.query_params.get('sort_by') or user.default_sort_field
        reverse = request.query_params.get('sort_order', 'asc') == 'desc'
