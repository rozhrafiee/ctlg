...
urlpatterns = [
    ...
    path("teacher/content/create/", LearningContentCreateView.as_view()),
    path("teacher/content/<int:pk>/update/", LearningContentUpdateView.as_view()),
    path("teacher/content/<int:pk>/delete/", LearningContentDeleteView.as_view()),
]
