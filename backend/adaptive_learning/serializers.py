# adaptive_learning/serializers.py
...
class LearningContentSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            'min_level', 'max_level', 'is_active', 'created_at', 'updated_at'
        ]
...
class LearningScenarioSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'json_structure', 'min_level', 'max_level']
...
class UserContentProgressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'user', 'content', 'started_at', 'completed_at', 'progress_percent']
        read_only_fields = ['id', 'user', 'content', 'started_at']
